...
View and edit saved reminders from the json file.

Reminders are shown in a list and can be deleted. Cron tab will
be automatically updated if they are all removed. The script can
be run with the executable file named 'reminders' for easy access
from the terminal. 
